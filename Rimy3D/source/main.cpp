...
const char * helpScreen =
    ...
    "\n"
    "Examples:\n"
    "  - To convert a .xact file to .3db, while saving any textures in the .jpg\n"
    "    file format and using all other settings as set in the GUI:\n"
    "  \n"
    "  Rimy3D.exe -texout jpg \"C:\\input.xact\" \"C:\\output.3db\"\n"
    "\n"
    ...
    "             -onlyverts 0 \"C:\\input.3db\" \"C:\\output.xact\"\n";
